		...
		try {
			if(isset($_POST['register'])){
				...
				if(!preg_match('/^[A-Za-z][A-Za-z0-9]{3,20}$/', $_POST['username'])){
					$this->data['errors']['username'] = 'Niepoprawny login (4-20 znaków, musi zaczynać się od litery i zawierać tylko małe i duże litery oraz cyfry)';
					...
					$_SESSION['messages'][] = 'Pomyślna rejestracja';
					header('Location: '.HREF);
				}
			}
