...
<div class="newest-pagination">
	...
	<?php if($data['page']-1 >= 1){ ?><a href="<?php echo HREF.$controllerClass.'/'.$action.'/'.($data['page']-1); ?>" class="more-newest-btn pag-nav"><</a><?php } ?>
	...
	<?php if($data['page']+1 <= $data['pages']){ ?><a href="<?php echo HREF.$controllerClass.'/'.$action.'/'.($data['page']+1); ?>" class="more-newest-btn pag-nav">></a><?php } ?>
</div>